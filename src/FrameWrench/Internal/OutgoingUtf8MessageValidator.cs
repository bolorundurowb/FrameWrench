...
/// <summary>
/// Mirrors <see cref="IncomingUtf8MessageValidator"/> for outbound frames: tracks whether a
/// fragmented Text message is in progress and validates the reassembled payload as
/// well-formed UTF-8 on the final frame (RFC 6455 §8.1).
/// </summary>
/// <remarks>
/// <para>
